      ...
      <main className="flex-1 flex flex-col px-6 py-12 space-y-16">
        ...
        <section className="text-center space-y-6 pt-4">
          ...
          >
            ...
            <span className="flex items-center gap-1">🔥 400+ 양자택일 선택지</span>
          </motion.div>
          ...
          >
            400개가 넘는 기상천외한 질문들로 당신의 무의식을 들여다보세요.{"\n"}
        ...
        <section className="grid grid-cols-1 gap-6 max-w-xl mx-auto">
          ...
          <div className="group rounded-3xl border border-zinc-900 bg-zinc-900/10 p-8 space-y-4 hover:border-zinc-800 transition-all duration-300">
            ...
            <p className="text-sm text-neutral-450 leading-relaxed">
              스트리머가 방을 만들고, 시청자가 6자리 PIN 코드로 접속하는 시참 모드입니다. 시청자가 스트리머의 진짜 취향과 선택을 예측하는 동안, 스트리머는 청자들과 다양한 썰을 풀며 즐거운 소통의 시간을 보낼 수 있습니다. (OBS 오버레이 제공(선택사항))
            </p>
          </div>
        ...
        <section className="border-t border-zinc-900/60 pt-16 max-w-xl mx-auto space-y-8 text-neutral-350 leading-relaxed text-sm md:text-base">
          <p className="indent-4 leading-loose">
            현대인들은 매일 수많은 선택의 기로에 놓입니다. 오늘 점심은 무엇을 먹을지, 주말에는 어떤 여가를 즐길지, 혹은 인간관계에서 어떤 태도를 취해야 할지 끊임없이 고민합니다. <strong className="text-neutral-100 font-extrabold">'기로'</strong>는 이러한 일상적인 고민부터, 상상조차 하기 싫은 극한의 딜레마까지 400개가 넘는 다양한 밸런스 게임을 통해 여러분의 숨겨진 심리와 취향을 탐구하는 종합 엔터테인먼트 플랫폼입니다.
          </p>
