    ...
    <div className="flex h-[100dvh] w-full flex-col overflow-y-auto overflow-x-hidden bg-[#080911] text-white selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <main className="flex-1 w-full max-w-3xl mx-auto px-6 py-10 flex flex-col">
        <div className="mb-10 text-center">
          <h1 className="text-2xl md:text-3xl font-black tracking-tight text-white mb-2">이용약관</h1>
          <p className="text-sm text-neutral-400">기로(Playkiro) 서비스 이용과 관련된 약관입니다.</p>
        </div>
        ...
        <div className="space-y-8 text-sm text-neutral-400 leading-relaxed font-normal bg-zinc-900/40 p-6 md:p-8 rounded-3xl border border-zinc-800/80 shadow-sm">
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제1조 (목적)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제2조 (용어의 정의)</h2>
            <p>본 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
            <ul className="list-decimal list-outside ml-4 space-y-1.5">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제3조 (약관의 게시와 개정)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제4조 (서비스의 제공 및 변경)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제5조 (서비스의 중단)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제6조 (사용자의 의무)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-extrabold text-neutral-200">제7조 (면책 및 책임제한)</h2>
