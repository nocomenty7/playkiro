      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-black text-zinc-900 dark:text-white tracking-tight">싱글모드 카테고리 선택</h2>
              <p className="text-xs text-zinc-500 dark:text-neutral-400">플레이하고 싶은 주제를 고르거나 [전체]로 시작하세요!</p>
            </div>
          </div>

          <form onSubmit={handleStartSubmit} className="space-y-4">
            {/* Category Filter Chips */}
            <div className="border-t border-zinc-200 dark:border-zinc-900/80 pt-4">
            ...
            <button
              type="submit"
              className="w-full py-3.5 rounded-xl bg-[#FFD700] text-zinc-950 font-black text-sm transition-all shadow-lg hover:brightness-110 flex items-center justify-center gap-2 cursor-pointer mt-6"
            >
